...
# NOTE: In these data sets, it was the Spontaneous emission (TM, electrons) that was extracted. 
sim_files_all = glob("extracted_intraband_SponEmiTMe_xGa_*_dEcPer_*.dat")
...
for sim_file in sim_files_all:
    ...
    # NOTE: even though the simualted spontaneous emission rate should be all greater than zero, it is still necessary to perform abs() 
...
outfile_name="all_simulation_data_processed_SponEmiTMe.txt"
outfile_header="xGa dEcPer  PL_normalised"
