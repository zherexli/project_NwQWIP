...
data_exp = data_exp_src[:,1]/data_exp_src[:,1].max()
...
num_dEc = 19
num_xGa = 99
xGa_design = np.linspace(0.05,0.932,num=num_xGa)
...
ax1.plot(wavelength_exp,data_exp,'ko',markersize=5,label='Experiment')
