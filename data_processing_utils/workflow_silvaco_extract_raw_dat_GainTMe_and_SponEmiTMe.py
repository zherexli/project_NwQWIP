...
#"Wavelength" "Gain (TM, electrons) (well 1) (1/cm)" "Spontaneous emission (TM, electrons) (well 1) (1/(s cm3 eV))"
...
#end for
sim_data_processed_Gain.shape = (int(sim_data_processed_Gain.size/(sim_data_temp.size+2)),sim_data_temp.size+2)
sim_data_processed_Gain = np.vstack((np.hstack((0,0,sim_wavelength)),sim_data_processed_Gain))
sim_data_processed_Spon.shape = (int(sim_data_processed_Spon.size/(sim_data_temp.size+2)),sim_data_temp.size+2)
